...
export default function Ventaro ERPPage() {
  return (
    <>
      ...
      <Meta property="og:title" content="Ventaro ERP — ERP y POS para MIPYMES · 305 Web Service" />
      ...
      <main>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p class="text-slate-400 text-lg leading-relaxed mb-6">
                  El corte de internet no para tu negocio. Ventaro ERP corre en tu red local y cuando vuelve la conexión, sincroniza todo automáticamente.
                </p>
                <div class="space-y-3">
                  {[
        ...
        <section class="py-14 bg-white">
          <div class="max-w-3xl mx-auto px-4 text-center">
            <h2 class="text-3xl font-black text-slate-900 mb-4">Prueba Ventaro ERP ahora mismo</h2>
