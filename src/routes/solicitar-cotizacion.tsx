...
export default function SolicitarCotizacionPage() {
  ...
  return (
    <>
      <Title>Solicitar Cotización Axis ERP · 305 Web Service</Title>
      <Meta name="description" content="Cotización personalizada para Axis ERP. Respuesta en menos de 2 horas. Planes desde $19/mes." />
          ...
          <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <Show when={params.exito === "1"}>
              <div class="text-center py-20">
                ...
                <a
                  href={erpWhatsApp("mi cotización de Axis ERP")}
                  target="_blank"
