...
const downloads: DownloadItem[] = [
  {
    ...
    filename: "Ventaro ERP-Setup.exe",
  ...
  },
  {
    ...
    filename: "Ventaro ERP-Portable.zip",
    url: erpConfig.downloads.windows,
    size: "~88 MB",
  ...
  },
  {
    ...
    filename: "Ventaro ERP-Server.exe",
  ...
  },
  {
    ...
    filename: "Ventaro ERP-Manual-v2.1.pdf",
...
export default function DescargasPage() {
  return (
    <>
      <Title>Descargas Ventaro ERP — Versión oficial v{erpConfig.version} · 305 Web Service</Title>
      <Meta name="description" content={`Descarga Ventaro ERP v${erpConfig.version}. Windows, Android, servidor LAN, manual PDF y documentación técnica. Versión oficial.`} />
      ...
      <main class="min-h-screen bg-[#020914]">
        ...
        <section class="pt-28 pb-12 relative overflow-hidden">
          ...
          <div class="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-4xl sm:text-5xl font-black text-white mb-4">Descarga Ventaro ERP</h1>
        ...
        <section class="py-12 border-t border-white/5">
          <div class="max-w-xl mx-auto px-4 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <a
                href={erpWhatsApp("instalación de Ventaro ERP")}
                target="_blank"
                rel="noopener noreferrer"
