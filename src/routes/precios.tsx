...
export default function PreciosPage() {
  return (
    <>
      <Title>Precios Axis ERP — Desde $19/mes · 305 Web Service</Title>
      <Meta name="description" content="Planes de Axis ERP desde $19/mes. Starter, Profesional, Restaurante y Enterprise. 14 días gratis sin tarjeta. Funciona offline." />
      <Meta property="og:title" content="Precios Axis ERP — Planes desde $19/mes · 305 Web Service" />
        ...
        <section class="bg-[#020914] pt-28 pb-4 relative overflow-hidden">
          ...
          <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 mb-5">
              ...
              <span class="text-indigo-300 text-xs font-semibold">Axis ERP — ERP/POS para Cuba y LATAM</span>
            </div>
