...
export const axisErpProduct: Product = {
  ...
  solution:
    "Ventaro ERP nació en LATAM para LATAM. Funciona sin internet en tu red local, sincroniza en la nube cuando hay conexión, acepta múltiples monedas y métodos de pago, y tiene módulos específicos para restaurantes, bares, ferreterías, farmacias y tiendas de todo tipo.",
  category: "ERP / POS",
  ...
  screenshots: [
    { url: "/screenshots/ventaro-dashboard.png", alt: "Dashboard Ventaro ERP",  caption: "Panel ejecutivo en tiempo real" },
    { url: "/screenshots/ventaro-pos.png",       alt: "POS Ventaro ERP",        caption: "Interfaz de punto de venta táctil" },
    { url: "/screenshots/ventaro-inventory.png", alt: "Inventario Ventaro ERP", caption: "Control de inventario por sucursal" },
  ],
  faq: [
    { question: "¿Funciona sin internet?",            answer: "Sí. Ventaro ERP funciona en tu red local (LAN) aunque no haya internet. Cuando vuelve la conexión, sincroniza todo automáticamente." },
...
export const erpFAQ = [
  {
    question: "¿Ventaro ERP funciona sin internet?",
    answer: "Sí. Ventaro ERP corre en tu red local (LAN) sin necesidad de internet. Cuando la conexión vuelve, sincroniza todo en la nube automáticamente. Tu negocio no para nunca.",
  },
  {
