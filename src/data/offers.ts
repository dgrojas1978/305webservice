...
const en: Offer[] = [
  ...
  },
  {
    ...
    priceState: "Scoped Proposal",
    bestFor: "Companies losing time to repetitive tasks, manual follow-ups and disconnected systems.",
    outcome: "Fewer manual steps, faster response times and cleaner data flow between the tools you already use.",
    inclusions: [
      "Workflow mapping",
    ...
    ctaLabel: "Find What We Can Automate",
    detail: {
      whoFor: "Teams that spend hours on repetitive tasks, manual follow-ups and copying data between tools that should be talking to each other.",
      problems: [
        "You copy the same data between tools every day.",
      ...
      useCases: [
        ...
        "Documents and invoices generated without manual copy-paste.",
        "Reports assembled automatically instead of by hand.",
      ],
      pricingMethod: "Scoped proposal. We map your workflow, identify the highest-value automations first and quote a fixed scope.",
      faq: [
...
const es: Offer[] = [
  ...
  },
  {
    ...
    priceState: "Propuesta con alcance",
    bestFor: "Empresas que pierden tiempo en tareas repetitivas, seguimientos manuales y sistemas desconectados.",
    outcome: "Menos pasos manuales, respuestas más rápidas y datos más limpios entre las herramientas que ya usas.",
    inclusions: [
      "Mapeo de flujos",
    ...
    ctaLabel: "Ver qué podemos automatizar",
    detail: {
      whoFor: "Equipos que pasan horas en tareas repetitivas, seguimientos manuales y copiando datos entre herramientas que deberían hablarse.",
      problems: [
        "Copias los mismos datos entre herramientas todos los días.",
      ...
      useCases: [
        ...
        "Documentos y facturas generados sin copiar y pegar a mano.",
        "Reportes armados automáticamente en vez de a mano.",
      ],
      pricingMethod: "Propuesta con alcance. Mapeamos tu flujo, identificamos primero las automatizaciones de mayor valor y cotizamos un alcance fijo.",
      faq: [
