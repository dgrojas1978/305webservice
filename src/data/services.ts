...
export const testimonials: Testimonial[] = [
  {
    ...
    content: "Venta POS transformó completamente nuestra tienda. Antes perdíamos horas en el inventario, ahora todo está en tiempo real. Lo mejor fue lo rápido que nos implementaron.",
    rating: 5,
    product: "Venta POS",
  },
  {
    ...
    content: "Calentico redujo nuestros no-shows en más del 60%. Los pacientes aman poder reservar desde el teléfono a cualquier hora y nosotros controlamos todo desde una sola pantalla.",
    rating: 5,
    product: "Calentico",
  },
  {
