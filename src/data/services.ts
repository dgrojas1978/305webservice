...
export const testimonials: Testimonial[] = [
  {
    ...
    content: "Ventaro ERP transformó completamente nuestra tienda. Antes perdíamos horas en el inventario, ahora todo está en tiempo real. Lo mejor fue lo rápido que nos implementaron.",
    rating: 5,
    product: "Ventaro ERP",
  },
  {
    ...
    content: "Ventaro ERP nos centralizó las tres sucursales en una sola pantalla. El modo offline fue clave — nunca perdemos una venta aunque falle la conexión.",
    rating: 5,
    product: "Ventaro ERP",
  },
  {
